...
def centroid_mapper(mp_obj, hg_obj):

    mp_vertices, mp_uv, mp_faces, mtl_file_mp, mtl_name_mp = read_obj(mp_obj)
    hg_vertices, hg_uv, hg_faces, mtl_file, mtl_name = read_obj(hg_obj)
    # print(mp_vertices)
...
if __name__ == "__main__":
    ...
    centroid_mapper(sys.argv[1], sys.argv[2])